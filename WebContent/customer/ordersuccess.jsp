	...
	<div class="cart-container order-success" id="cart_wrap"> 
    	<article class="order-module" id="order_success" data-id="12266119358749105"> 
     		...
     		<p class="omodule-actions"> 
     			<a class="ui-btn btn-small" href="${pageContext.request.contextPath }/ShowOrderInfoServlet">查看我的订单</a> 
     			<a class="ui-btn btn-small" href="${pageContext.request.contextPath }/ShowStoreInfoServlet">返回首页</a> 
     			<a class="ui-btn btn-small" href="${pageContext.request.contextPath }/ShowFoodInfoServlet?storeId=${storeId }">返回店铺</a> 
     		</p> 
    	</article> 
